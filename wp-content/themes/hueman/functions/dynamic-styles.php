...
@media only screen and (min-width: 720px) {
	#nav-header .nav ul { background-color: '.ot_get_option('color-header-menu').'; }
			...
			if ( ot_get_option('body-background') != '' ) {
				...
				if(isset($body_background['background-color'])) $body_color = $body_background['background-color'];
				if(isset($body_background['background-image'])) $body_image = $body_background['background-image'];
				if(isset($body_background['background-position'])) $body_position = $body_background['background-position'];
				if(isset($body_background['background-attachment'])) $body_attachment = $body_background['background-attachment'];
				if(isset($body_background['background-repeat'])) $body_repeat = $body_background['background-repeat'];
				if(isset($body_background['background-size'])) $body_size = $body_background['background-size'];
				...
				} elseif ( isset($body_background['background-color']) ) {
